...
/* Button color This isn't always going to be the same color...*/

/* Button content Should the button always read "ACTIVATE ALL"? When should it read "DECOMMISSION ALL"? */
